...
#### <a name="current"></a>[Google Drive](https://www.google.com/drive/)
...
#### <a name="current"></a>[Evernote](https://evernote.com) 
...
#### <a name="current"></a>[Reddit](https://www.reddit.com/)

Online forum for discussion of almost anything

#### <a name="current"></a>[Quora](https://www.quora.com/)
...
#### <a name="current"></a>[Craigslist](https://www.craigslist.org/about/sites)

A website for people to post things they are trying to sell locally, good place to find a lot of deals
...
These are developer tools that I find add a lot of value to my work flow.

#### <a name="current"></a>[Git/Github](https://github.com/)

Git is a distributed version-control system, a tool to manage your source code history. GitHub is a hosting service for Git repositories. So they are not the same thing: Git the tool, GitHub the service for projects that use Git. 

#### <a name="current"></a>[Heroku](https://www.heroku.com/)

Cloud platform that allows for rapid development of web applications.  Handy and easy to get started with to get project ideas into a live web environment.

#### <a name="current"></a>[Stackoverflow](http://stackoverflow.com/) 

Online forum for developers, it has helped me solve many technical problems since I have started using it.
...
#### <a name="current"></a>[Adobe Products](https://en.wikipedia.org/wiki/Adobe_Creative_Suite) 

Adobe Photoshop, Adobe Flash, Adobe Premiere, Adobe AfterEffects, and Adobe Soundbooth are tools to edit media files. I have used their product since Macromedia 

#### <a name="current"></a>[Terminal](http://www.opengroup.org/unix) 

The command line interface tool found in the [MacOS](https://en.wikipedia.org/wiki/MacOS) (that allows a programmer to control [UNIX](http://www.unix.org/what_is_unix.html) operations.  Working with the command line allows a developer to have more control of the operating system they are working on.  This was difficult to set up in Windows which is probably  one of the less-known reasons why they lost so many users in the past decade.
...
#### <a name="current"></a>[Microsoft Visual Studio](https://en.wikipedia.org/wiki/Microsoft_Visual_Studio)

A very good software IDE for .NET development.

#### <a name="current"></a>[ReSharper](https://www.jetbrains.com/resharper/)

An productivity extension to Microsoft Visual Studio to help with coding routines such as finding compiler errors, redundancies, and intellisense.

#### <a name="current"></a>[Notepad++](https://notepad-plus-plus.org/)

My favorite text editor for the Windows OS.

#### <a name="current"></a>[Microsoft Paint](https://en.wikipedia.org/wiki/Microsoft_Paint)

One of the computer programs I ever got my hands dirty with, still use it for quick things from time to time.
...
An infrastructure of programming technologies to develop desktop applications and webservices on the Microsoft OS.

- [C#](https://en.wikipedia.org/wiki/C_Sharp_(programming_language))
- [WPF](https://en.wikipedia.org/wiki/Windows_Presentation_Foundation)
- [WCF](https://en.wikipedia.org/wiki/Windows_Communication_Foundation)

#### [Java](https://en.wikipedia.org/wiki/Java_(programming_language))

One of the core programming languages, object-oriented. It is also the main programming language for developing Android apps.

#### [C/C++](https://en.wikipedia.org/wiki/C%2B%2B)

One of the core programming languages.

#### [Objective-C](https://en.wikipedia.org/wiki/Objective-C)

C with small-talk style messaging added. It is the main programming language for iOS and MacOSX app development.

#### [HTML](https://en.wikipedia.org/wiki/HTML)

One of the foundations of front-end web development, it defines the content of web pages

#### [CSS](https://en.wikipedia.org/wiki/HTML)

One of the foundations of front-end web development, it defines the presentation of web pages including layout, fonts, and color.

#### [Javascript](https://en.wikipedia.org/wiki/HTML)

One of the foundations of front-end web development, it defines the behavior of web pages.

#### [ActionScript 3](http://www.adobe.com/devnet/actionscript/learning.html)

When I first made freelance websites flash was the cool way to make them since they allowed animations which HTML didn't support at the time, AS3 was the programming language for the Adobe Flash environment.

#### [Python](https://www.python.org/)

A dynamically-typed multi-purpose programming language.

#### [PHP](http://php.net/)

A server-side scripting language that can be embedded into HTML.

#### [MySQL](https://en.wikipedia.org/wiki/MySQL)

Standard language to communicate with the database in a relational database management system.

#### [Turbo C](https://en.wikipedia.org/wiki/Borland_Turbo_C)

My first exposure to programming was during a computer class in summer school during high school.  We experimented around with coding using if-else statements to take in some basic input and do arithmetic on it.  This was the starting point of my interest in code.
...
#### <a name="past games"></a>[Half-Life: Counter-Strike](https://en.wikipedia.org/wiki/Counter-Strike_(video_game))
